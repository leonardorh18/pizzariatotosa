...
<div id="cadastro-div">
    ...
    $nome = isset($_POST['field_nome']) ? $_POST['field_nome'] : $sabor[0]->getNome();
    $ingr = isset($_POST['field_ingredientes']) ? $_POST['field_ingredientes'] : $sabor[0]->getIngredientes();
    $cod = isset($_POST['field_codigo']) ? $_POST['field_codigo'] : $sabor[0]->getCodigo();
    ?>
    </div>
    <br><br>
